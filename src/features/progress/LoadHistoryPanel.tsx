    ...
    return (
      <Card className="mt-5" variant="outlined">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-md-secondary">Histórico de cargas</p>
    ...
    <Card className="mt-5" variant="outlined">
      ...
      <div className="mt-4 space-y-3">
        {summaries.slice(0, 4).map((summary) => (
          <article className="rounded-md bg-md-surface-container-low p-3" key={summary.exerciseId}>
            <div className="flex items-start justify-between gap-3">
              <h3 className="min-w-0 text-sm font-semibold">
                {summary.exerciseName}
              </h3>
              <span className="shrink-0 text-xs font-medium text-md-on-surface-variant">
