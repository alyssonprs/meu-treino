...
- Execucao de treino (UX-0003): mostrar a lista completa da rotina, com aquecimento e cooldown em faixas compactas e exercicios em uma unica lista com imagem local, prescricao e status; tocar em um exercicio abre a execucao individual. A lista nao mostra series, progresso, descanso, carga ou formulario inline.
- Execucao de exercicio (UX-0009): mostrar somente o exercicio selecionado, com guia visual, carga anterior, progresso de series, descanso e registro final de carga/reps; marcar series concluidas durante o exercicio para disparar descanso entre series; RIR nao aparece como campo obrigatorio na primeira versao e fica reservado para melhoria futura. Ao registrar o resultado, oferecer proximo exercicio ou retorno a lista; no ultimo exercicio, oferecer finalizar a rotina.
- Timer de descanso global: enquanto houver treino, exercicio e descanso ativos, exibir uma pilula flutuante em todas as telas do app; tocar nela retorna ao exercicio que iniciou o descanso. O timer usa uma hora final em memoria para manter a contagem durante a navegacao e nao persiste apos recarregar o app.
...
- Ao tocar em uma rotina na lista do menu `Treino`, o app deve abrir a UX-0003 com a lista completa de exercicios; tocar em um exercicio abre a UX-0009 para a execucao individual.
