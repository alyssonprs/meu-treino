...
```text
Use AGENTS.md e docs/arquitetura/arquitetura-prompt.md como referencia.
...
- Antes de criar a interface final, aprove o fluxo e as telas em `docs/arquitetura/ux-prototipo-aprovado.md`.

## Execucao -1 - Prototipar UX antes do desenvolvimento

Objetivo: validar todas as telas principais antes de codar a interface.

Status: concluida em 2026-06-15. As telas `UX-01` a `UX-14` foram aprovadas em `docs/arquitetura/ux-prototipo-aprovado.md`.
...
Pronto quando: as telas principais estiverem desenhadas, revisadas e marcadas como aprovadas ou aprovadas com ajustes em docs/arquitetura/ux-prototipo-aprovado.md.
```
...
```text
Use AGENTS.md, docs/arquitetura/arquitetura-prompt.md e docs/arquitetura/identidade-visual-opcoes.md como referencia.
...
Status: concluida em 2026-06-15. Capacitor foi configurado com alvo Android, `appId` `com.meutreino.app`, scripts de sync/open, projeto nativo em `android/`, assets oficiais de identidade e instrucoes em `docs/arquitetura/android.md`.
...
```text
Use AGENTS.md, docs/arquitetura/arquitetura-prompt.md e o JSON modelo como referencia.
...
Status: concluida em 2026-06-15. O build web e `pnpm run android:sync` foram validados com sucesso, os assets web foram sincronizados para o projeto Android e `docs/arquitetura/android.md` foi atualizado com instrucoes de APK/AAB.
...
Status: concluida em 2026-06-15. Revisao final registrada em `docs/ajustes/revisao-final-primeira-versao.md`, sem bloqueadores criticos; foi adicionada uma protecao para falha de carregamento local inicial e os checks finais foram executados.
...
Atualize `docs/arquitetura/arquitetura-prompt.md` quando a decisao afetar o produto ou a arquitetura, por exemplo:
