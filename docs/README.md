...
Use para decisoes duraveis de produto, arquitetura, UX, identidade, distribuicao PWA e Android.

Principais referencias:

- `arquitetura/arquitetura-prompt.md`: fonte canonica de produto e arquitetura.
- `arquitetura/ux-prototipo-aprovado.md`: contrato de UX aprovado.
